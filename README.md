...
- **🚀 [FleetReloc OSS Preview](https://github.com/nadja-mansurov/fleetreloc-oss-preview):** Public reference architecture for a high-concurrency B2B fleet telematics platform built with privacy-first local LLM parsing and WhatsApp Webhook pipelines (designed with GCC / MENA B2B fleet contexts in mind).
